...
1. Download the gyrOSC app and set the IP address to the computer running the TouchDesigner file, and set the port to the same as in the gyrOSC node in TouchDesigner (currently set to 10000).
