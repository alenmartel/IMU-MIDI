...
5. If you are using MainStage, the current TouchDesigner file takes up to six (6) different instruments. In Mainstage, be sure to enable and set the program of your six instruments (000 to 005). For this performance, '0' and '2' default to NO INSTRUMENT, meaning no sound, so the instruments start at 001 to and 003 to 005. So, in TouchDesigner, if you want to hear anything, make sure the 'Instrument' slider in the otuermost base is set to '1' or '3' to '5'. Adding more instruments requires some changes to TouchDesigner files, so if you would like this, then please let me know. (Photo Reference available in this Git)
